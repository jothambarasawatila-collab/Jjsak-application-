...
// Initial realistic audit records showing compliance
const INITIAL_AUDIT_SEED: RoleChangeAuditRecord[] = [
  {
    id: 'rc-audit-001',
    recordHash: 'sha256_8f21bc90_JJSAK-SEC-AUDIT-v1',
    institutionId: 'sch-ngonyek-001',
    institutionName: 'St. Teresa Ngonyek High School',
    affectedUserId: 'usr-005',
    affectedUserName: 'Ms. C. Wanjiru',
    previousRole: 'TEACHER',
    newRole: 'CLASS_TEACHER',
    actionType: 'ASSIGNMENT',
    initiatorId: 'usr-002',
    initiatorName: 'Mrs. J. Barasa',
    initiatorRole: 'HEAD_OF_INSTITUTION',
    approverId: 'usr-002',
    approverName: 'Mrs. J. Barasa',
    approverRole: 'HEAD_OF_INSTITUTION',
    date: '2026-08-20',
    time: '08:45:12',
    timestamp: '2026-08-20T08:45:12.000Z',
    deviceInfo: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/130.0',
    ipAddress: '197.232.44.12',
    reason: 'Statutory appointment as Grade 7 Stream A Class Teacher for Academic Year 2026 Term 3.',
    isImmutable: true,
    notificationDispatched: true,
  },
  {
    id: 'rc-audit-002',
    recordHash: 'sha256_4e19da77_JJSAK-SEC-AUDIT-v1',
    institutionId: 'sch-ngonyek-001',
    institutionName: 'St. Teresa Ngonyek High School',
    affectedUserId: 'usr-004',
    affectedUserName: 'Mr. P. Otieno',
    previousRole: 'TEACHER',
    newRole: 'DIRECTOR_ACADEMICS',
    ...
    ipAddress: '197.232.44.12',
    reason: 'Executive appointment to the Sole Academic Administrator post (Director of Academics) following Board recommendation.',
    isImmutable: true,
    notificationDispatched: true,
  },
  {
    id: 'rc-audit-003',
    recordHash: 'sha256_7c34bb11_JJSAK-SEC-AUDIT-v1',
    institutionId: 'sch-ngonyek-001',
    institutionName: 'St. Teresa Ngonyek High School',
    affectedUserId: 'usr-002',
    affectedUserName: 'Mrs. J. Barasa',
    previousRole: 'DEPUTY',
    newRole: 'HEAD',
    actionType: 'PROMOTION',
    initiatorId: 'usr-001',
    initiatorName: 'Jotham Barasa Watila',
    initiatorRole: 'SYSTEM_ADMIN',
    approverId: 'usr-001',
    approverName: 'Jotham Barasa Watila',
    approverRole: 'SYSTEM_ADMIN',
    date: '2026-07-01',
    time: '10:00:00',
    timestamp: '2026-07-01T10:00:00.000Z',
    deviceInfo: 'Mozilla/5.0 (X11; Linux x86_64) Firefox/131.0',
    ipAddress: '102.219.208.5',
    reason: 'Super Administrator confirmation of institutional Head of Institution appointment under TSC deployment.',
    isImmutable: true,
    notificationDispatched: true,
  },
];
